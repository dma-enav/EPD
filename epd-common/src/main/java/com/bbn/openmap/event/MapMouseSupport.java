...
public class MapMouseSupport extends ListenerSupport<MapMouseListener> {
    ...
    protected static Logger logger = Logger
            .getLogger("com.bbn.openmap.event.MapMouseSupport");
    ...
    public static final int PROXY_DISTRIB_MOUSE_PRESSED = 1 << 0;
    public static final int PROXY_ACK_CONSUMED_MOUSE_PRESSED = 1 << 1;
    public static final int PROXY_DISTRIB_MOUSE_RELEASED = 1 << 2;
    public static final int PROXY_ACK_CONSUMED_MOUSE_RELEASED = 1 << 3;
    public static final int PROXY_DISTRIB_MOUSE_CLICKED = 1 << 4;
    public static final int PROXY_ACK_CONSUMED_MOUSE_CLICKED = 1 << 5;
    public static final int PROXY_DISTRIB_MOUSE_MOVED = 1 << 6;
    public static final int PROXY_ACK_CONSUMED_MOUSE_MOVED = 1 << 7;
    public static final int PROXY_DISTRIB_MOUSE_DRAGGED = 1 << 8;
    public static final int PROXY_ACK_CONSUMED_MOUSE_DRAGGED = 1 << 9;
    public static final int PROXY_DISTRIB_MOUSE_ENTERED = 1 << 10;
    public static final int PROXY_DISTRIB_MOUSE_EXITED = 1 << 11;
     ...
     *            if true, events are propagated to the first MapMouseListener
     *            that successfully processes the event, if false, events are
     *            propagated to all MapMouseListeners
     */
    ...
    public boolean fireMapMousePressed(MouseEvent evt) {
        ...
        if (DEBUG) {
            logger.fine("  -- has proxy (" + (proxy != null)
...
//            priorityListener = null;
     ...
     *            object notify its targets of events if the parent is acting as
     *            a proxy.

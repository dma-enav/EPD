...
public class RouteLoader {
    ...
    public static Route loadKml(File file, RouteManagerCommonSettings<?> routeMgrSettings) throws RouteLoadException {
        KmlParser kmlParser = new KmlParser(file, routeMgrSettings);

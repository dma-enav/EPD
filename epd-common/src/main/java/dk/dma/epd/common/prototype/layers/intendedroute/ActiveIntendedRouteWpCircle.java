 ...
 */
public class ActiveIntendedRouteWpCircle extends WpCircle {
    private static final long serialVersionUID = 1L;

    private IntendedRouteGraphic intendedRouteGraphic;
    private int index;

    public ActiveIntendedRouteWpCircle(IntendedRouteGraphic intendedRouteGraphic, int index, double latitude, double longitude, Color color, float scale) {
        super(latitude, longitude, 0, 0, (int)(30.0 * scale), (int)(30.0 * scale));

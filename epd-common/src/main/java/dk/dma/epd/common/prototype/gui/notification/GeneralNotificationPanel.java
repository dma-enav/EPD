    ...
    protected NotificationTableModel<GeneralNotification> initTableModel() {
        return new NotificationTableModel<GeneralNotification>() {
            ...
            public Object getValueAt(int rowIndex, int columnIndex) {
                ...
                case 1: return notification.getNotificaitonSeverity() == NotificationSeverity.ALERT
                                ? ICON_ALERT
                                : (notification.getNotificaitonSeverity() == NotificationSeverity.WARNING ? ICON_WARNING : null);

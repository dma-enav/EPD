...
/**
 * Maritime cloud service for exchanging routes suggestions from a sea traffic control center (STCC) to ship.
 * <p>
 ...
 * <li>{@linkplain RouteSuggestionMessage} Used for sending a suggested route from STCC to a ship and a status back from the ship to
 * the STCC.</li>
...
public class RouteSuggestionService {
    ...
    public enum RouteSuggestionStatus {
        ...
        PENDING(Color.YELLOW), ACCEPTED(new Color(130, 165, 80)), REJECTED(new Color(165, 80, 80)), WAIT(new Color(130, 130, 200));
    ...
    /**
     * Used for sending a suggested route from STCC to a ship and a status back from the ship to the STCC
     */
    public static class RouteSuggestionMessage extends TODO.ServiceMessage<RouteSuggestionReply> implements Serializable {
        ...
        /**
         * Some of the cloud status updates may arrive out of order. Use the {@code CloudMessageStatus.combine()} method to make
         * sure the order is maintained
         * 
         * @param cloudMessageStatus
         *            the new cloud message status
         */

...
public class ShoreConnectionSettingsPanel extends BaseSettingsPanel {
    ...
    public ShoreConnectionSettingsPanel() {
        super("Connections", new ImageIcon(ShoreConnectionSettingsPanel.class.getResource("/images/settings/connections.png")));
        setLayout(null);
        ...
        shorePanel.setBorder(new TitledBorder(null, "Shore Services", TitledBorder.LEADING, TitledBorder.TOP, null, null));
        ...
        aisPanel.setBorder(new TitledBorder(null, "AIS", TitledBorder.LEADING, TitledBorder.TOP, null, null));
        ...
        wmsPanel.setBorder(new TitledBorder(null, "WMS", TitledBorder.LEADING, TitledBorder.TOP, null, null));

...
public class ScaleDisplayLayer extends EPDLayerCommon implements
        ProjectionListener {
    ...
    public ScaleDisplayLayer(DrawingAttributes dAtts, Length units) {
        this();
    ...
    protected String defaultUnitOfMeasureString = "NM";
    ...
    public java.awt.Component getGUI() {
        if (palette == null) {
            ...
            palette.setLayout(new javax.swing.BoxLayout(palette,
                    javax.swing.BoxLayout.Y_AXIS));
            palette.setBorder(new javax.swing.border.TitledBorder(
                    "Unit Of Measure"));
            ...
            for (Length lengthType : Length.getAvailable()) {
                ...
                jrb.setSelected(uom.getAbbr().equalsIgnoreCase(
                        lengthType.getAbbr()));
                buttons.add(jrb);
            }
            ...
            for (JRadioButton button : buttons) {
                button.setSelected(uom.getAbbr().equalsIgnoreCase(
                        button.getText()));
            }
        }
    ...
    public void projectionChanged(ProjectionEvent e) {
        ...
        double dist = GreatCircle.sphericalDistance(loc1.getRadLat(),
                loc1.getRadLon(), loc2.getRadLat(), loc2.getRadLon());
...
//            } else if (uom.equals(Length.MILE) || uom.equals(Length.DM)
...
//        }
        ...
        graphics.add(line);
         ...
         if (new_dist < 1.0f) {
             ...
             outtext = String.format("%.0f %s", new_dist, cur_uom.getAbbr());
         }
...
//        String outtext = String.format("%.1f %s", new_dist, cur_uom.getAbbr());
        // }
    ...
    protected int getPtAtDistanceFromLatLon(LatLonPoint loc2, double unitDist,
        ...
        LatLonPoint newX = GreatCircle.sphericalBetween(loc2.getRadLat(),
                loc2.getRadLon(), lineWidthInRadians, RADIANS_270);

...
public class SendStrategicRouteDialog extends ComponentDialog implements ActionListener {
    ...
    public void initGUI() {
        ...
        routePanel.add(zoomBtn, 
                new GridBagConstraints(0, 2, 2, 1, 0.0, 0.0, WEST, NONE, insets5, 0, 0));
        ...
        requestPanel.add(new JLabel("Message:"), 
                new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0, NORTHWEST, NONE, insets5, 0, 0));
        requestPanel.add(scrollPane, 
                new GridBagConstraints(1, 0, 1, 1, 1.0, 1.0, WEST, BOTH, insets5, 0, 0));
